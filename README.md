...
- `type`:
  ...
  - You can reference the type by using the exported `InputType` enum: `InputType.Text`, `InputType.Number`, `InputType.Email`, `InputType.Password`, `InputType.Date`, `InputType.Range`, `InputType.TextArea`, `InputType.Select`
  - Optional
  - Default: `text`
